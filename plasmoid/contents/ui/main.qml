    ...
    fullRepresentation: ColumnLayout {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                PlasmaComponents.Label {
                    text: fullRepRoot.cpuCoresExpanded ? "▲" : "▼"
                    font.pixelSize: 10; opacity: 0.5
                    MouseArea {
                        anchors.fill: parent
                        anchors.margins: -4
                        onClicked: fullRepRoot.cpuCoresExpanded = !fullRepRoot.cpuCoresExpanded
                    }
                }
            }

            ColumnLayout {
                visible: fullRepRoot.cpuCoresExpanded
                ...
                Flickable {
                    ...
                    clip: true
                    contentHeight: coresCol.implicitHeight
                    contentWidth: width
